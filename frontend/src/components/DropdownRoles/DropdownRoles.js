...
import './DropdownRoles.css'

const Icon = () => {
  /* function that return the icon for the dropdown */
  return (
...
const CloseIcon = () => {
  /* function that return the icon for the close button */
  return (
      <svg height="20" width="20" viewBox="0 0 20 20">
...
const DropdownRoles = ({placeHolder, options, isMulti, isSearchable, onChange}) => {
  ...
  return (
    <div className="dropdown-container">
      <div className="dropdown-input" onClick={handlerInputClick}>
